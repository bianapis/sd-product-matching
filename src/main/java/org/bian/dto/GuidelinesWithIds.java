 ...
 * GuidelinesWithIds
 */
public class GuidelinesWithIds   {
  private String productMatchingAssessmentReference = null;
  ...
  private String productMatchingGuidelines = null;


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return productMatchingAssessmentReference
  **/

  public String getProductMatchingAssessmentReference() {
    return productMatchingAssessmentReference;
  }

  public void setProductMatchingAssessmentReference(String productMatchingAssessmentReference) {
    this.productMatchingAssessmentReference = productMatchingAssessmentReference;
  }
  ...
  **/
   ...
   * @return productMatchingGuidelines
  **/

  public String getProductMatchingGuidelines() {
    return productMatchingGuidelines;
  }

  public void setProductMatchingGuidelines(String productMatchingGuidelines) {
    this.productMatchingGuidelines = productMatchingGuidelines;
  }
